...
$.ajax({type: 'get', async: false, url: https.api.masterGood}).done(function(res) {
    data = res;
})
let index = 0;
...
export default class Goodsort extends React.Component {
    constructor(props) {
        super(props);
